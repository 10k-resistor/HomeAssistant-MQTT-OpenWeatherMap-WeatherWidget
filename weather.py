...
ATTRIBUTION = 'Data provided by an own Weather Station and OpenWeatherMap'
...
mqttBaseTopic =  "/home/garten/esp-bmp/#"
mqttTempTopic = "/home/garten/esp-bmp/temperatur"
mqttHumidityTopic = "/home/garten/esp-bmp/luftfeuchtigkeit"
mqttPressureTopic = "/home/garten/esp-bmp/luftdruck"
mqttVccTopic = "/home/garten/esp-bmp/vcc"
mqttHeatIndexTopic = "/home/garten/esp-bmp/heatindex"
...
def message_received(msg):
    ...
    mqttTopic = msg.topic
    if(mqttTopic == mqttTempTopic):
        global mqttTemp
        mqttTemp = float(mqttPayload)
    if(mqttTopic == mqttHumidityTopic):
        global mqttHumidity
        mqttHumidity = float(mqttPayload)
    if(mqttTopic == mqttPressureTopic):
        global mqttPressure
        mqttPressure = float(mqttPayload)
    if(mqttTopic == mqttVccTopic):
        global mqttVcc
        mqttVcc = float(mqttPayload)
        mqttVcc = mqttVcc / 100
        mqttVcc = round(mqttVcc,2)
...
def setup_platform(hass, config, add_entities, discovery_info=None):
    ...
    #topic = config['myWeather'].get('topic', mqttBaseTopic)
    ...
    mqtt.subscribe(mqttBaseTopic, message_received)
